-- Migration: Create batch friendship score calculation RPC
-- Calculates scores for ALL friends of a user in a single database call
...
GRANT EXECUTE ON FUNCTION calculate_batch_friendship_scores(UUID) TO authenticated;

COMMENT ON FUNCTION calculate_batch_friendship_scores IS 
'Calculates friendship scores for ALL friends of a user in a single call.
Returns JSON with array of scores for each friend.';
